...
Most of my projects combine software, electronics and practical applications. Over time I primarily settled on Node.js for web projects, .NET/C# for desktop applications and C++ for AVR and ESP microcontrollers.

I mainly work with KiCad, VSCode and Visual Studio 2022 depending on the project.
